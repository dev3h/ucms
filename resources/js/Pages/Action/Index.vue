<template>
    <AdminLayout>
        <div class="w-full h-full bg-white">
            ...
            <div class="w-full">
                <div class="w-full flex justify-between px-4 gap-2 my-2">
...
export default {
    ...
    methods: {
        async fetchData(page = 1) {
            ...
            await axios.get(this.appRoute("admin.api.action.index", params)).then(response => {
        ...
        async deleteItem(id) {
            await axios.delete(this.appRoute("admin.api.action.destroy", id)).then(response => {
