        ...
        <div class="w-full py-4">
            <div class="w-full flex justify-between items-center my-[15px]">
                ...
                <div class="flex justify-end w-full">
                    <el-button type="primary" size="large" @click="openAssign(id)">Add subsystems</el-button>
                </div>
...
export default {
    ...
    methods: {
        async fetchData(page = 1) {
            ...
            await axios.get(this.appRoute("admin.api.module.all-subsystem", {
                id: this.id,
                ...params
            })).then(response => {
        ...
        openAssign(id) {
            this.$refs.modalAssign.open(id, 'subsystem')
        },
        openDeleteForm(id) {
            this.$refs.deleteForm.open(id)
        },
        async deleteItem(subsystemId) {
            await axios.delete(this.appRoute("admin.api.module.remove-subsystem", {id: this.id, subsystem_id: subsystemId})).then(response => {
