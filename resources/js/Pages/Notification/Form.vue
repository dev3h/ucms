                    ...
                    <div class="w-full flex gap-[48px]">
                        ...
                        <div class="flex-1">
                            <el-form-item label="Title" prop="title" :error="getError('title')" :inline-message="hasError('title')">
                                <el-input size="large" v-model="formData.title"  />
                            </el-form-item>
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                title: [{ required: true, message: 'この項目は必須です。', trigger: ['blur', 'change'] }],
                content: [{ required: true, message: 'この項目は必須です。', trigger: ['blur', 'change'] }],
                sender_type: [{ required: true, message: 'この項目は必須です。', trigger: ['blur', 'change'] }],
                posted_at: [{ required: true, message: 'この項目は必須です。', trigger: ['blur', 'change'] }],
                // user_ids: { required: true, message: 'この項目は必須です。', trigger: ['blur', 'change'] },
            },
            listUsers: [],
        }
    },
